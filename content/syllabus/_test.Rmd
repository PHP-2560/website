...
- [Online Book](http://http://statseducation.com/Introduction-to-R/)
...
## `r advdate(mon, 1)`: NO CLASS: First Class will be September 11th 


- **NO CLASS**
- You are expected to complete work before the first class.
- Familiarize yourself with:
    - [Course Website](http://www.php2560.com/)
    - [Github](https://www.github.com/)
    - [RStudio](https://www.rstudio.com)


## `r advdate(mon, 2)`: Syllabus / Getting Started / Github
...
## `r advdate(mon, 3)`: R Basics and Data Types / Working with Dplyr and Tidyr
...
##  `r advdate(mon, 5)`:  Controlling the Flow
...
##  `r advdate(mon,65)`: Functions in R
...
##  `r advdate(mon, 7)`: Functions in R: Part 2
...
##  `r advdate(mon, 8)`: Writing Efficient R Code

- Working on more Efficient Coding
- *Require Reading*:
    - [Advanced R Chapter 23](https://adv-r.hadley.nz/perf-measure.html)
    - [Advanced R Chapter 24](https://adv-r.hadley.nz/perf-improve.html)
...
##  `r advdate(mon, 10)`: Text Mining in R
