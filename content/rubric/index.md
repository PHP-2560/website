...
|Use of Git | Commit history shows the workflow and thought process. Commit messages are meaningful and intuitive.  | There are some commits and some have meaningful messages.  | Very little commit history. Hard to follow and does show a logical workflow.  |
